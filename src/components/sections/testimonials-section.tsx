...
import { CheckCircle } from "lucide-react"; // Import icon for verified tick
        ...
        <div className="grid gap-8 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
          {testimonials.map((testimonial) => (
            <Card
                ...
                className={cn(
                    "glass-card-glow flex flex-col justify-between",
                    // Removed transform: translateY on hover from globals.css, keeping only shadow glow
                )}
            >
