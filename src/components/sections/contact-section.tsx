             ...
             <div className="space-y-5 text-muted-foreground font-normal">
               ...
               <div className="space-y-3">
                 ...
                 <div className="flex items-center space-x-4">
                    {/* WhatsApp SVG Icon - Apply text-primary */}
                    <a href={whatsappLink} target="_blank" rel="noopener noreferrer" className="text-primary hover:text-primary/80 transition-colors">
                    ...
                    {/* Instagram Icon - Apply text-primary */}
                    <a href="https://instagram.com/mathengeinc" target="_blank" rel="noopener noreferrer" className="text-primary hover:text-primary/80 transition-colors">
                      <Instagram className="h-6 w-6" />
                    </a>
                    {/* TikTok SVG Icon - Apply text-primary */}
                    <a href="https://tiktok.com/@mathengeinc" target="_blank" rel="noopener noreferrer" className="text-primary hover:text-primary/80 transition-colors">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
